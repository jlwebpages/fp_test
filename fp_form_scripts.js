      ...
      if (tie_breaker_needed == true)
      {
         ...
         if ( (unable_to_break_tie == true) || (in_progress_mn_points < 1) )
         {
            ...
            if (unable_to_break_tie == false)
            {
               ...
               d.writeln('<input type=text class="default_text border_radius" style="border: 1px solid black; width: 10px" name="mn_points" size="3" maxlength="3" value="'+mn_pts_value+'"');
