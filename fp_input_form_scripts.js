...
function build_regular_season_form()
{
   ...
   d.writeln('<td class="bt2_border" style="text-align: left;  padding-left:  5px" colspan="1"><input type=text id="mn_points" class="default_text border_radius" style="touch-action: none; width: 30px" name="mn_points" size="2" maxlength="2"></td>');
...
function build_post_season_form()
{
   ...
   for (var i = 1; i <= number_of_ps_games; i++)
   {
      ...
      d.writeln('    <input type=text class="default_text border_radius" style="touch-action: none; font-size: 12pt" name="spread'+i+'" size="2" maxlength="2">');
      d.writeln('</font></td>');
      d.writeln('</tr>');
      d.writeln('');
   }
   ...
   d.writeln('<td class="no_border" style="text-align: left;  padding-left:  5px" colspan="1"><input type=text id="total_points" class="default_text border_radius" style="touch-action: none; font-size: 12pt; width: 35px" name="points" size="2" maxlength="2"></td>');
