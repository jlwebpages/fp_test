...
function build_regular_season_form()
{
   ...
   d.writeln('');
   d.writeln('   //JLtop.display_frame("fp_loading_indicator",0);');
   d.writeln('');
   ...
   d.writeln('         {');
   d.writeln('            alert("1");nfl_odds = nfl_connection.responseText;');
   d.writeln('');
   ...
   d.writeln('               {');
   d.writeln('                  alert("2");get_nfl_odds(document,sportsline,true);');
   d.writeln('               }');
   d.writeln('               else');
   d.writeln('               {');
   d.writeln('                  // Remove loading indicator.');
   d.writeln('');
   d.writeln('                  alert("3");top.display_frame("fp_main",0);');
   d.writeln('               }');
   d.writeln('            }');
   d.writeln('');
   d.writeln('            if (odds_source == sportsline)');
   d.writeln('            {');
   d.writeln('               alert("4");process_nfl_odds_from_sportsline(document,nfl_odds,suppress_alerts);');
   d.writeln('');
   d.writeln('               // Remove loading indicator.');
   d.writeln('');
   ...
   d.writeln('            {');
   d.writeln('               alert("5");get_nfl_odds(document,sportsline,true);');
   d.writeln('            }');
   d.writeln('            else');
   d.writeln('            {');
   ...
   d.writeln('      if ( (odds_source == espn_scoreboard) && (week == current_input_week) )');
   d.writeln('      {');
   d.writeln('         Alert("6");get_nfl_odds(document,sportsline,true);');
   d.writeln('      }');
   d.writeln('      else');
   d.writeln('      {');
   d.writeln('         if (suppress_alerts == false) alert("\\"get_nfl_odds\\" failed.");');
   ...
   d.writeln('   //JLnfl_odds = nfl_odds.replaceAll(String.fromCharCode(92),"");');
   d.writeln('alert("a");');
   d.writeln('   // Parse the nfl_odds string.');
   d.writeln('');
