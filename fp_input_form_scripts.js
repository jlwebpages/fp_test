...
function build_regular_season_form()
{
   ...
   d.writeln('<td class="bt2_border" style="text-align: left;  padding-left:  5px" colspan="1"><input type=email class="default_text border_radius" style="width: 55px" name="mn_points"></td>');
