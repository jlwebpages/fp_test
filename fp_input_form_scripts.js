...
function build_regular_season_form()
{
   ...
   d.writeln('<td class="bt2_border" style="text-align: left;  padding-left:  5px" colspan="1"><input type=text id="mn_points" class="default_text border_radius" style="width: 30px; touch-action: none" name="mn_points" size="2" maxlength="2"></td>');
