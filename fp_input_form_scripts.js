...
function build_regular_season_form()
{
   ...
   d.writeln('   <select class="background_color" style="vertical-align: bottom; font-family: Calibri; font-size: 14pt; border: 1px solid gray; color: red" name="selected_week_menu" size=1 onChange="change_week(document); return true;">');
   ...
   d.writeln('<select style="font-size: 12pt; font-family: Calibri; background-color:#C4D79B; border: 1px solid gray; color: red" name="player_name_menu" size=1 onChange="get_player_index_from_form(document); return true;">');
   ...
   for (var i = 1; i <= number_of_rs_games; i++)
   {
      ...
      if (i == number_of_rs_games)
      {
         ...
         d.writeln('<td nowrap class="gr1_border"><select style="font-size: 11pt; font-family: Calibri; border: 1px solid lightgray; background-color:white; color: red" name="pick'+i+'" size=1>');
      }
      else
      {
         ...
         d.writeln('<td nowrap><select style="font-size: 11pt; font-family: Calibri; border: 1px solid lightgray; background-color:white; color: red" name="pick'+i+'" size=1>');
      }
      ...
      if (i == number_of_rs_games)
      {
         d.writeln('<td nowrap class="no_border"><select style="font-size: 11pt; font-family: Calibri; border: 1px solid lightgray; background-color:white; color_red" name="weight'+i+'" size=1>');
      }
      else
      {
         d.writeln('<td nowrap class="gb1_border"><select style="font-size: 11pt; font-family: Calibri; border: 1px solid lightgray; background-color:white; color: red" name="weight'+i+'" size=1>');
      }
      d.writeln('       <option selected value="">');
   ...
   d.writeln('<input id="picks_from_odds" type=button class="button" name="picks_from_odds" value="Picks From Odds" onClick="generate_picks_from_odds(document); return true;" title="'+picks_from_odds_tooltip+'">');
   d.writeln('&nbsp&nbsp;');
   d.writeln('</span>');
   d.writeln('<input id="home_team_picks" type=button class="button" name="home_team_picks" value="Home Team Picks" onClick="generate_home_team_picks(document); return true;" title="'+home_team_picks_tooltip+'">');
   d.writeln('&nbsp&nbsp;');
   d.writeln('<input id="random_picks" type=button class="button" name="random_picks" value="Random Picks" onClick="generate_random_picks(document); return true;" title="'+random_picks_tooltip+'">');
   d.writeln('</td>');
   d.writeln('</tr>');
   d.writeln('');
   ...
   d.writeln('<input id="submit" type=button class="button" name="submit" value="Accept" onClick="accept_picks(document); return true;" title="'+accept_tooltip+'">');
   d.writeln('&nbsp&nbsp;');
   d.writeln('<input id="reset_button" type=button class="button" name="reset_button" value="Reset" onClick="reset_input_form(document); return true;" title="'+reset_tooltip+'">');
   d.writeln('</td>');
   d.writeln('</tr>');
   d.writeln('');
...
function build_post_season_form()
{
   ...
   d.writeln('<select style="font-size: 13pt; font-family: Calibri; background-color:#C4D79B; border: 1px solid gray; color_red" name="player_name_menu" size=1 onChange="get_player_index_from_form(document); return true;">');
   ...
   for (var i = 1; i <= number_of_ps_games; i++)
   {
      ...
      if (i == number_of_ps_games)
      {
         ...
         d.writeln('<td nowrap class="gr1_bb2_border"><select style="font-size: 12pt; font-family: Calibri; border: 1px solid lightgray; background-color:white; color: red" name="pick'+i+'" size=1>');
      }
      else
      {
         ...
         d.writeln('<td nowrap><select style="font-size: 12pt; font-family: Calibri; border: 1px solid lightgray; background-color:white; color: red" name="pick'+i+'" size=1>');
      }
      d.writeln('       <option selected value="">');
      d.writeln('       <option          value="H">H');
      d.writeln('       <option          value="V">V');
