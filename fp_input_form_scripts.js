...
function build_regular_season_form()
{
   ...
   d.writeln('<input id="submit" type="button" class="default_button" style="margin-right: 15px" name="submit" value="Accept" onClick="accept_picks(document); return true;" title="'+accept_tooltip+'">');
