...
function build_regular_season_form()
{
   ...
   d.writeln('<td id="input_form_week" nowrap class="no_border"><font style="font-size: 18pt">Jnput Form - Week&nbsp;</font>');
   d.writeln('   <select class="background_color black_color" style="vertical-align: bottom; font-family: Calibri; font-size: 14pt; border: 1px solid gray; border-radius: 0px" name="selected_week_menu" size=1 onChange="change_week(document); return true;">');
   ...
   d.writeln('<select class="black_color" style="font-size: 12pt; font-family: Calibri; background-color:#C4D79B; border: 1px solid gray" name="player_name_menu" size=1 onChange="get_player_index_from_form(document); return true;">');
   ...
   for (var i = 1; i <= number_of_rs_games; i++)
   {
      ...
      if (i == number_of_rs_games)
      {
         ...
         d.writeln('<td nowrap class="gr1_border"><select class="black_color" style="font-size: 11pt; font-family: Calibri; border: 1px solid lightgray; background-color:white" name="pick'+i+'" size=1>');
      }
      else
      {
         ...
         d.writeln('<td nowrap><select class="black_color" style="font-size: 11pt; font-family: Calibri; border: 1px solid lightgray; background-color:white" name="pick'+i+'" size=1>');
      }
      ...
      if (i == number_of_rs_games)
      {
         d.writeln('<td nowrap class="no_border"><select class="black_color" style="font-size: 11pt; font-family: Calibri; border: 1px solid lightgray; background-color:white" name="weight'+i+'" size=1>');
      }
      else
      {
         d.writeln('<td nowrap class="gb1_border"><select class="black_color" style="font-size: 11pt; font-family: Calibri; border: 1px solid lightgray; background-color:white" name="weight'+i+'" size=1>');
      }
      d.writeln('       <option selected value="">');
   ...
   d.writeln('<input id="submit" type=button class="default_button" name="submit" value="Accept" onClick="accept_picks(document); return true;" title="'+accept_tooltip+'">');
   d.writeln('&nbsp&nbsp;');
...
function build_post_season_form()
{
   ...
   d.writeln('<select class="black_color" style="font-size: 13pt; font-family: Calibri; background-color:#C4D79B; border: 1px solid gray" name="player_name_menu" size=1 onChange="get_player_index_from_form(document); return true;">');
   ...
   for (var i = 1; i <= number_of_ps_games; i++)
   {
      ...
      if (i == number_of_ps_games)
      {
         ...
         d.writeln('<td nowrap class="gr1_bb2_border"><select class="black_color" style="font-size: 12pt; font-family: Calibri; border: 1px solid lightgray; background-color:white" name="pick'+i+'" size=1>');
      }
      else
      {
         ...
         d.writeln('<td nowrap><select class="black_color" style="font-size: 12pt; font-family: Calibri; border: 1px solid lightgray; background-color:white" name="pick'+i+'" size=1>');
      }
      d.writeln('       <option selected value="">');
      d.writeln('       <option          value="H">H');
      d.writeln('       <option          value="V">V');
