...
function build_regular_season_form()
{
   ...
   d.writeln('<tr>');
   d.writeln('<td class="bt2_border" style="text-align: right; padding-right: 6px" colspan="4"><font style="font-size: 12pt">Game '+number_of_rs_games+' Total Points:</font></td>');
   d.writeln('<td class="bt2_border" style="text-align: left;  padding-left:  4px" colspan="1"><input type=text class="default_text border_radius" style="width: 30px" name="mn_points" size="2" maxlength="2"></td>');
